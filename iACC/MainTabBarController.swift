...
class MainTabBarController: UITabBarController {
	...
	private func makeFriendsList() -> ListViewController {
        ...
        let cache = FriendsCacheItemsServiceAdapter(cache: friendsCache, select: { [weak vc] item in
            vc?.select(friend: item)
        })
...
struct FriendsAPIItemsServiceAdapter: ItemsService {
    let api: FriendsAPI // Dependency Injection
...
struct CardsAPIItemsServiceAdapter: ItemsService {
    let api: CardAPI // Dependency Injection
...
struct SentTransfersAPIItemsServiceAdapter: ItemsService {
    let api: TransfersAPI // Dependency Injection
